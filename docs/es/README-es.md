...
![jinja con la inyeccion de secrets web v1](../images/webv1.png)  

+ Respuesta HTTP del Servidor Web en Producción (v2):
![jinja con la inyeccion de secrets web v2](../images/webv2.png)  

+ Destrucción Limpia de Infraestructura:
![pipeline destroy](../images/pipeline_destroy.png)  
